...
namespace Apex.WorldGeometry
{
    ...
    public abstract partial class DynamicObstacleBase : ExtendedMonoBehaviour, IDynamicObstacle, ILoadBalanced, IHandleMessage<GridStatusMessage>
    {
        ...
        private void Awake()
        {
            ...
            var character = _transform.parent.GetComponent<Character>();
            if (_transform.parent != null && (_mover == null && character != null))
            {
                _mover = character.GetComponentInChildren<IMovingObject>();
            } 
